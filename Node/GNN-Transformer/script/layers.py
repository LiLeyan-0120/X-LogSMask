...
from .utils import visualize_attention_heads
...
class MultiHeadAttention(torch.nn.Module):
    def __init__(self, embed_size, heads):
        ...
        # self.alpha = nn.Parameter(torch.tensor(1/0.2))  # Add learnable alpha parameter, initialized to 1/0.3
    ...
    def forward(self, values, keys, queries, graph=None):
        ...
        # visualize_attention_heads(pre_graph_energy, post_graph_energy, attention, sample_idx=0, save_path="result/visualize/attention_comparison.eps")
...
class TransformerBlock(nn.Module):
    ...
    def forward(self, value, key, query, graph=None):
